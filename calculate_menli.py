...
def compute_nli_score(pred_path: str):
    ...
    mdl = AutoModelForSequenceClassification.from_pretrained(model_name, num_labels=3, cache_dir=".cache").to(device)
    mdl.eval()
...
def main():
    ...
    compute_nli_score(args.pred_path)
